...
<!--- <cfdump var="#Request.BusTypeTemplates#" />
<cfdump var="#Request.VehicleVersions#" />
<cfdump var="#Request.Vehicles#" abort="true" /> --->
                  ...
                  <div class="form-group">
                    ...
                    <div class="busTemplateHTML">
                      ...
                      <cfloop query="#Request.VehicleVersions#">
                        <p>
                        <span><input type="radio" name="versionid" required="required" value="#VERSIONID#"/>Bus #countBus#</span> <br/>
                        <b>Version ID: </b>#VERSIONID#<br/>
                        <b>Vehicle Version Name: </b>#VERSIONNAME#<br/>
                        <b>Vehicle Manufacturer Name: </b>#MANUFACTURERSNAME#<br/>
                        <b>Model ID: </b>#MODELID#<br/>
                        <b>Vehicle Model Name: </b>#MODELNAME#<br/>
                        <b>Vehicle Seats: </b>#SEATS#<br/>
                        <!--- <b>Vehicle Virtual Version ID: </b>#VEHICLE_VIRTUAL_VERSION_ID#<br/> --->
                        <!--- <b>Vehicle Type ID: </b>#VECHICLETYPEID#<br/> --->
                        </p>
                        <cfset countBus++/>
    ...
    <section class="bus-builder">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              ...
              <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-12" id="selectedseats"></div>
                    <div class="col-md-12" id="selectedseats1"></div>
                    <div class="col-md-12" id="selectedseats2"></div>
                    <div class="col-md-12" id="selectedseats3"></div>
                    <div class="col-md-12" id="selectedseats4"></div>
                    <div class="col-md-12" id="selectedseats5"></div>
                    <div class="col-md-12" id="selectedseats6"></div>
                    <div class="col-md-12" id="selectedseats7"></div>
                    <div class="col-md-12" id="selectedseats8"></div>
                    <div class="col-md-12" id="selectedseats9"></div>
                    <div class="col-md-12" id="selectedseats10"></div>
                    <div class="col-md-12" id="selectedseats11"></div>
                    <div class="col-md-12" id="selectedseats12"></div>
      ...
      <div class="bus-build-actions pull-right">
        <cfif xmlData EQ ''>
          ...
          <button type="submit" class="btn btn-success" id="updateSaveBus" onclick="generatUpdateXml(this,'#Form.dimensionType#')" style="display: none;">Update Bus</button>
          <button type="submit" class="btn btn-danger" id="deleteBus" onclick="deleteXml(this,'#Form.dimensionType#')" style="display: none;">Delete Bus</button>
        ...
        <cfelse>
          ...
          <button type="submit" class="btn btn-danger" onclick="deleteXml(this,'#Form.dimensionType#')">Delete Bus</button>
        </cfif>
      </div>
