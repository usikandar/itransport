...
<!---   <cfset qvar = Request.Vehicles>
 ...
 --->
  <div class="row">
    <div class="col-md-8">
      <h3 class="portlet-title"><u>Build Custom Bus</u></h3>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-12">
      <div <cfif Form.sub_btn NEQ ''> class="searchTbl div-hide" <cfelse> class="searchTbl"</cfif> style="position: absolute;">
        ...
        <div class="table-scroll" style="max-height: 400px;">
          <zd:table title="Buses" style="font-size: 13px;"
            headers="&nbsp;,Vehicle Version,Vehicle Type Name,Virtual Version ID,Vehicle Type VechicleID">
            <tr>
            <cfloop query="#Request.Vehicles#">
              <td><span><div class="radioP"><input type="radio" name="versionid" id="#Request.Vehicles.currentRow#" required="required" value="#VEHICLE_VERSION_ID#, #VECHICLETYPEID#, #VEHICLE_VIRTUAL_VERSION_ID#"/><label class="label label-secondary" for="#Request.Vehicles.currentRow#"><span class="radioButtonGraph"></span>&nbsp;Bus #Request.Vehicles.currentRow#</label></div>
              </td>
              <td>#VEHICLE_VERSION_ID#</td>
              <td>#VEHICLETYPENAME#</td>
              <td>#VEHICLE_VIRTUAL_VERSION_ID#</td>
              <td>#VECHICLETYPEID#</td></tr>
              <!--- <cfset countBus++/> --->
            </cfloop>
          </zd:table>
        </div>
      ...
      <div class="addTbl" style="position: absolute;display: none;">
        <form method="post" action="">
            <div class="col-md-6">
              ...
              <cfset count = 1/>
              <div class="table-scroll" style="max-height: 400px;">
                <zd:table title="Templates" style="font-size: 13px;"
                  headers="&nbsp;,Vehicle Type,Seat Max,Seat Max Row,Bus Row,Floors">
                  <cfloop query="Request.BusTypeTemplates">
                    <tr>
                    <td>
                      <span><div class="radioP"><input type="radio" name="bustemplate" id="#Request.BusTypeTemplates.currentRow#_1" required="required" value="#SeatMAX#,#SeatMaxRow#,#BusRows#,#Floors#,#VECHICLETYPEID#"><label class="label label-secondary" for="#Request.BusTypeTemplates.currentRow#_1"><span class="radioButtonGraph"></span>&nbsp;Dimension #count#</label></div>
                    </td>
          ...
          <div class="col-md-6">
            ...
            <div class="table-scroll" style="max-height: 400px;">
              <zd:table title="Vehicle Versions" style="font-size: 13px;"
                headers="&nbsp;,Version,Version,Manufacturer,Model,Model,Seats">
                <!--- <cfloop query="#Request.Vehicles#">
                  <tr>
                  <td>
                    <span><div class="radioP"><input type="radio" name="versionid" id="#Request.Vehicles.currentRow#_1" required="required" value="#VEHICLE_VERSION_ID#, #VEHICLE_VIRTUAL_VERSION_ID#"><label class="label label-secondary" for="#Request.Vehicles.currentRow#_1"><span class="radioButtonGraph"></span>&nbsp;Bus #countBus#</label></div>
                  </td>
                  <td>#VEHICLE_VERSION_ID#</td>
                  <td>#VEHICLETYPENAME#</td>
                  <td>#VEHICLE_VIRTUAL_VERSION_ID#</td>
                  <td>#VECHICLETYPEID#</td>
                  </tr>
                  <cfset countBus++/>
                </cfloop> --->
                <cfloop query="#Request.VehicleVersions#">
                  <tr>
                  <td>
                    <span><div class="radioP"><input type="radio" name="versionid" id="#Request.VehicleVersions.currentRow#_2" required="required" value="#VERSIONID#"><label class="label label-secondary"<span class="radioButtonGraph"></span>&nbsp;Bus #countBus#</label></div>
                  </td>
                  <td>#VERSIONID#</td>
                  <td>#VERSIONNAME#</td>
  ...
  <cfif Form.sub_btn EQ 'builtbus'>
    ...
    <section class="bus-builder">
      ...
      <div class="row row-spaced-Y">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 big-bus-container">
          <div class="big-bus">
