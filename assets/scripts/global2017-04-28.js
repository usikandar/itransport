...
var busBuilderTable = function () {
	...
	if (vehicleIsConfigured) {
		...
		for (var rnum = rowStart; rnum <= rowEnd; rnum++) {
			...
			if(count==2){
				//console.log(diffRows,'Condition True');
				//Here Adding First Row in Bus.	
				seatBoxLowerHTML = seatBoxLowerHTML + '</tr>';
				...
				for (var cnum = colStart; cnum <= colEnd; cnum++){
					seatBoxLowerHTML = seatBoxLowerHTML + "<td style='border-style:solid;border-width:1px;color:#F96725;'><input id='boxLower" + rnum + cnum + "' type='text' class='seat_box' onchange='seatBoxHandler(this)'></input></td>";
					seatBoxUpperHTML = seatBoxUpperHTML + "<td style='border-style:solid;border-width:1px;color:#F96725;'><input id='boxUpper" + rnum + cnum + "' type='text' class='seat_box' onchange='seatBoxHandler(this)'></input></td>";

					seatDesignLowerHTML = seatDesignLowerHTML + "<td  style='background-color:#F96725;' id='designLower" + rnum + cnum + "' class='vehicle-seat' onclick='seatDesignHandler(this)'></td>";
					seatDesignUpperHTML = seatDesignUpperHTML + "<td  style='background-color:#F96725;' id='designUpper" + rnum + cnum + "' class='vehicle-seat' onclick='seatDesignHandler(this)'></td>";
				}
				seatBoxLowerHTML = seatBoxLowerHTML + '</tr>';
				seatBoxUpperHTML = seatBoxUpperHTML + '</tr>';
				...
				seatDesignUpperHTML = seatDesignUpperHTML + '</tr>';
					...
					//Here Adding Second Row in Bus.
				seatBoxLowerHTML = seatBoxLowerHTML + '<tr style="background-color:#F96725;">';
				for (var cnum = colStart; cnum <= colEnd; cnum++){
					seatBoxLowerHTML = seatBoxLowerHTML + "<td style='border-style:solid;border-width:1px;color:#F96725;'><input id='boxLower" + rnum + cnum + "' type='text' class='seat_box' onchange='seatBoxHandler(this)'></input></td>";
					seatBoxUpperHTML = seatBoxUpperHTML + "<td style='border-style:solid;border-width:1px;color:#F96725;'><input id='boxUpper" + rnum + cnum + "' type='text' class='seat_box' onchange='seatBoxHandler(this)'></input></td>";
...
var generatXml  = function (el) {
    ...
    type: "POST",
    url: "Ajax.cfm",
    data: {ajaxAction: 'saveBusStructure', xmlData: xmlStringFinal, VechicleTypeID: vehicleTypeId},
    returnformat:'json',
