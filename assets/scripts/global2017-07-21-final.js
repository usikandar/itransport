      ...
      for (var cnum = colStart; cnum <= colEnd; cnum++) {
        ...
        if(rowCount == 13 || rowCount == 14){
          ...
          if(selected == 'selected'){
            ...
            seatDesignLowerHTML = seatDesignLowerHTML + "<td style='"+style+"' rel='" + rnum + cnum + "' dimension='"+dimension+"' seatId='"+seatID+"' id='designLower" + rnum + cnum + "' class='vehicle-seat "+classToappend+"' onclick='getSelectedSeat(this)'>"+seatID+"</td>";//seatDesignHandler(this)
