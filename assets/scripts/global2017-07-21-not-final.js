      ...
      for (var cnum = colStart; cnum <= colEnd; cnum++) {
        ...
        if(rowCount == 13 || rowCount == 14){
          ...
          if(selected == 'selected'){
            ...
            seatDesignLowerHTML = seatDesignLowerHTML + "<td style='"+style+"' rel='" + rnum + cnum + "' dimension='"+dimension+"' seatId='"+seatID+"' id='designLower" + rnum + cnum + "' class='vehicle-seat "+classToappend+"' onclick='getSelectedSeat(this)'></td>";//seatDesignHandler(this)
...
var getSelectedSeat = function (el) {
  ...
  // console.log($(el).html(),"string of html");
  ...
  var lowerSeats = $('#seat-design-lower')
    ...
    .map(function() {
      i++;
      console.log($(this).attr("seatId"), "html lower value");
      if(i==1)
  ...
  var upperSeats = $('#seat-design-upper')
    ...
    .map(function() {
      i++;
      console.log($(this).attr("seatId"), "html upper value");
      if(i==1)
        return $(this).attr("seatId");
      else
        return "," + $(this).attr("seatId");
...
// var values = $("#"+setID+">option").map(function() { return $(this).val(); });
...
for(let i=0; i<=values.length; i++){
  console.log(values[i], "index value");
