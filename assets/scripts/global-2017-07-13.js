...
var generatXml  = function (el,dimensionType) {
    ...
    type: "POST",
    url: "Ajax.cfm",
    data: {ajaxAction: 'saveBusStructure', dimensiontype: dimensionType, xmlData: xmlStringFinal, VechicleTypeID: vehicleTypeId, vehicleID: vehicleId},
    returnformat:'json',
...
var generatUpdateXml  = function (el,dimensionType) {
    ...
    type: "POST",
    url: "Ajax.cfm",
    data: {ajaxAction: 'updateBusStructure', dimensiontype: dimensionType, xmlData: xmlStringFinal, VechicleTypeID: vehicleTypeId, vehicleID: vehicleId},
    returnformat:'json',
    	success: function (data) {
    		if(data!==''){
          alert(data);
