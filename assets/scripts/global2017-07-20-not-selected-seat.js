      ...
      for (var cnum = colStart; cnum <= colEnd; cnum++) {
        ...
        if(rowCount == 13 || rowCount == 14){
          ...
          if(selected == 'selected'){
            ...
            seatDesignLowerHTML = seatDesignLowerHTML + "<td style='"+style+"' rel='" + rnum + cnum + "' dimension='"+dimension+"' id='designLower" + rnum + cnum + "' class='vehicle-seat "+classToappend+"'></td>";//seatDesignHandler(this)
