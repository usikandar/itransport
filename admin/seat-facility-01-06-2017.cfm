<cfoutput>
  ...
  <!--- body start --->
  <h2 class="sub-header">Manage Seat Facilities</h2>
  <div class="row">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST" action="" enctype="multipart/form-data">
                        <button data-edit_id="#delete_id#" data-name="#Request.allData.Name#" data-imagepath="#Request.allData.ImagePath#" data-seatid="#Request.allData.SeatCategoryFacilityID#" type="button" class="btn btn-info updateDialog" data-toggle="modal" data-target="##updateModal">Edit</button>
