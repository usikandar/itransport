...
<!--- #expandPath('')# --->
  ...
  <cfset PageAPI = createObject("component", "cfc.SeatClass").init(Application.DSN) />
  ...
  <cfset Request.activeClass = 'SeatClass'/>
  <cfinclude template="includes/header.cfm"/>

  <!--- body start --->
  <div class="row">
    <h3 class="portlet-title"><u>Manage Seat Classes</u></h3>
              ...
              <tbody>
                <cfloop query="Request.allData">
                  <tr>
                    ...
                    <td>
                      <cfset delete_id = Request.allData.SeatClassID/>
