...
<cfoutput>
  ...
  <!--- <cfset Application.DS = "iTransport"/> --->
  ...
  <!--- body start --->
  <div class="row">
    <h3 class="portlet-title"><u>Manage Seat Types</u></h3>
    ...
    <div class="tab-content">
      ...
      <div id="add" class="tab-pane fade">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
          ...
          <button type="submit" name="btn_submit" value="add" class="btn btn-success pull-right"><i class="fa fa-save"></i> <cfoutput>#ml.get_label('save')#</cfoutput></button></td></tr>
