<cfoutput>
  <cfset SeatClassAPI = createObject("component", "cfc.SeatClass").init(Application.DSN) />
  ...
  <cfif Form.btn_submit EQ 'add'>
    ...
    <cfelse>
      ...
      <cfset result = SeatClassAPI.create(Form)>
  ...
  <cfelseif Form.btn_submit EQ 'edit'>
    ...
    <cfelse>
      ...
      <cfset result = SeatClassAPI.update(Form)>
  ...
  <cfelseif Form.btn_submit EQ 'Delete' AND isNumeric(Form.delete_id)>
    ...
    <cfset result = SeatClassAPI.delete(Form)>
  ...
  <cfset Request.allData = SeatClassAPI.list()/>
  ...
  <!--- body start --->
  <h2 class="sub-header">Manage Seat Classes</h2>
  <div class="row">
