...
<cfoutput>
  ...
  <cfset PageAPI = createObject("component", "cfc.SeatCategoryFacility").init(Application.DSN) />
  ...
  <cfset Request.activeClass = 'SeatCategoryFacilities'/>
  <cfinclude template="includes/header.cfm"/>

  <!--- body start --->
  <!--- <h2 class="sub-header"></h2> --->
  <div class="row">
  <h3 class="portlet-title"><u>Manage Seat Category Facilities</u></h3>
  ...
  <div class="row">
    ...
    <div class="tab-content">
              ...
              <tbody>
                <cfloop query="Request.allData">
                  <tr>
                    ...
                    <td>
                      <cfset delete_id = Request.allData.SeatCategoryFacilityID/>
                      <form method="POST" action="" enctype="multipart/form-data">
                        <button type="button" data-edit_id="#delete_id#" data-name="#Request.allData.Name#" data-imagepath="#Request.allData.ImagePath#" class="btn btn-info updateDialog" data-toggle="modal" data-target="##updateModal"><i class="fa fa-edit"></i> <cfoutput>#ml.get_label('edit')#</cfoutput></button>
      ...
      <div id="add" class="tab-pane fade">
        <h3>Add a Seat Category Facility</h3>
        <form method="POST" action="" enctype="multipart/form-data">
