<cfcomponent name="SeatCategoryFacility" hint="Seat Category Facility all functions">

  <cffunction name="init" access="public" returntype="SeatCategoryFacility">
    <cfargument name="dsnName" type="string" required="true" hint="ColdFusion DSN Name" />
    <cfset variables.myMyDSNName = arguments.dsnName />
    <cfset variables.myProcedureName = 'Vehicle__BUS_DIM_SeatCategoryFacility__CRUD' />
    <cfreturn this />
  </cffunction>
  ...
  <cffunction name="list" returntype="query" output="no" access="public">
    ...
    <cfstoredproc datasource="#dsnName#" procedure="#variables.myProcedureName#">
      ...
      <cfif arguments.getID NEQ ''>
        <cfprocparam type="in" cfsqltype="cf_sql_integer" dbvarname="@SeatCategoryFacilityID" value="#arguments.getID#">
      </cfif>
  ...
  <cffunction name="update" returntype="query" output="no" access="public">
    ...
    <cfquery name="qUpdate" datasource="#dsnName#" >
      ...
      EXEC  @return_value = [dbo].[#variables.myProcedureName#]
            @action = N'U',
            @SeatCategoryFacilityID = #Form.edit_id#,
            @Name = N'#Form.name#',
            @ImagePath = N'#Form.filePath#'
    ...
    <!--- <cfstoredproc datasource="#dsnName#" procedure="#variables.myProcedureName#">
      ...
      <cfprocparam type="in" cfsqltype="cf_sql_varchar" dbvarname="@Name" value="#Form.name#">
      <cfprocparam type="in" cfsqltype="cf_sql_integer" dbvarname="@SeatCategoryFacilityID" value="#Form.edit_id#">
  ...
  <cffunction name="delete" returntype="query" output="no" access="public">
    ...
    <cfstoredproc datasource="#dsnName#" procedure="#variables.myProcedureName#">
      ...
      <cfprocparam type="in" cfsqltype="cf_sql_integer" dbvarname="@SeatCategoryFacilityID" value="#Form.delete_id#">
