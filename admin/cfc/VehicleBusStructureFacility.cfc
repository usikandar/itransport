<cfcomponent name="VehicleBusStructureFacility" hint="Vehicle__BUS__Structure__Facility__CRUD functions">

  <cffunction name="init" access="public" returntype="VehicleBusStructureFacility">
    <cfargument name="dsnName" type="string" required="true" hint="ColdFusion DSN Name" />
    <cfset variables.myMyDSNName = arguments.dsnName />
    <cfset variables.myProcedureName = 'Vehicle__BUS__Structure__Facility__CRUD' />
    <cfreturn this />
  </cffunction>
  ...
  <cffunction name="create" returntype="any" output="no" access="public">
    ...
    <cfquery name="qCreate" datasource="#dsnName#" >
      ...
      EXEC  @return_value = [dbo].[#variables.myProcedureName#]
            ...
            @BusSeatFacility__XML = N'#Form.XMLDATA#'
