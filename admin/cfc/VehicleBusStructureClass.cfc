<cfcomponent name="VehicleBusStructureClass" hint="Vehicle__BUS__Structure__Class__CRUD functions">

  <cffunction name="init" access="public" returntype="VehicleBusStructureClass">
    <cfargument name="dsnName" type="string" required="true" hint="ColdFusion DSN Name" />
    <cfset variables.myMyDSNName = arguments.dsnName />
    <cfset variables.myProcedureName = 'Vehicle__BUS__Structure__Class__CRUD' />
    <cfreturn this />
  </cffunction>
    ...
    <cfquery name="qCreate" datasource="#dsnName#" >
      ...
      EXEC  @return_value = [dbo].[#variables.myProcedureName#]
          ...
          <cfelse>
            ...
            @BusSeatClass__XML = N'#Form.XMLDATA#'
